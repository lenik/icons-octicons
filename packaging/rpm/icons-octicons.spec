...
GitHub Octicons
.
Provides icon assets under /usr/share/icons-octicons, a preview index, and a
launcher `icons-octicons` (`iconlib -l octicons`).
...
%files
%{_bindir}/icons-octicons
%{_datadir}/bash-completion/completions/icons-octicons
%{_mandir}/man1/icons-octicons.1*
%{_datadir}/icons-octicons/
%{_datadir}/doc/icons-octicons/
