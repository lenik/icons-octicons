...
.\build.ps1 -Name icons-octicons -Version 1.2.3
```
...
```
<project>/.config/icons-octicons/<packaging>.build-host
$HOME/.config/icons-octicons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-octicons
```
